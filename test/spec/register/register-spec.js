...
//	});
    ...
    it('Will proceed with user registration', function(done) {
        request.post(registerUrl, {json:true, body: registerAtrubin}, function(error, response, body) {
...
xdescribe('User validation', function() {
    it('Will proceed with bad request code for invalid user', function(done) {
        request.post(registerUrl, {json:true, body: registerInvalid}, function(error, response, body) {
            expect(response.statusCode).toEqual(400);
